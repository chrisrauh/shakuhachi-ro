...
- [ ] [UI] [Medium] Investigate letter spacing for font aesthetics and legibility.
...
- [ ] [Both] [High] Fix auth state on score detail page
...
- [ ] [Backend] [Medium] Auto-save to database
...
- [ ] [Backend] [High] Fix ABC notation format not saveable to database
...
- [ ] [Backend] [Medium] Consider slug update behavior when title changes
...
- [ ] [UI] [Medium] Investigate button text vertical alignment
...
- [ ] [UI] [High] Improve button test page visual regression coverage
...
- [ ] [Research] [Low] Investigate web component framweworks

- [ ] [Both] [High] Delete score with confirmation
...
- [ ] [Backend] [High] **Add options validation with warnings**
...
- [ ] [Backend] [High] **Add typed error classes**
...
- [ ] [Backend] [Medium] **Clean up public API surface**
...
- [ ] [Backend] [High] **Fix async API consistency**
...
- [ ] [Backend] [High] **Add fluent API pattern**
...
- [ ] [Backend] [High] **Replace getter methods with property getters**
...
- [ ] [Backend] [High] **Improve naming consistency**
...
- [ ] [Backend] [Medium] **Add event system for lifecycle hooks**
...
- [ ] [Backend] [Medium] **Flexible constructor overloads**
...
- [ ] [Backend] [Medium] **Multi-container support**
...
- [ ] [Backend] [High] **Subpath exports for better tree-shaking**
...
- [ ] [Backend] [Medium] **Prepare v2.0 release**
...
- [ ] [UI] [High] Update existing visual tests to capture both light and dark mode
...
- [ ] [UI] [High] Add visual regression tests for Editor page (/editor)
  - [ ] Test default empty state
  - [ ] Test with score data entered
  - [ ] Test viewport and full page screenshots
- [ ] [UI] [High] Add visual regression tests for Score page (/score)
  - [ ] Test score rendering (full page and viewport)
  - [ ] Test debug mode
  - [ ] Test different viewport sizes (desktop, tablet, mobile)
- [ ] [UI] [High] Update Browse page visual tests to properly test library view
  - [ ] Test empty state (no scores)
  - [ ] Test with scores displayed
  - [ ] Test search/filter interactions
- [ ] [UI] [High] Add cross-viewport testing (desktop 1280x720, tablet 768x1024, mobile 375x667)
- [ ] [UI] [High] Add visual tests for different auth states (logged in vs logged out)

### Phase 8: Navigation & UI Polish

- [ ] [UI] [High] Test geometricPrecision on shakuhachi SVG notes
- [ ] [UI] [High] Create site header component (logo, navigation)
- [ ] [UI] [High] Add navigation links: Home | Create Score | My Scores | Profile
- [ ] [UI] [High] Add auth UI: Login/Signup or Username/Logout
- [ ] [UI] [High] Create footer with attribution
- [ ] [UI] [High] Add consistent styling (CSS framework or custom)
- [ ] [UI] [High] Implement responsive design (mobile, tablet, desktop)
- [ ] [UI] [High] Add loading spinners and error states
- [ ] [UI] [High] Polish form validation and error messages
- [ ] [UI] [High] Test across browsers (Chrome, Firefox, Safari)
...
- [ ] [Backend] [High] SVGRenderer.closeGroup(): throw on unmatched group instead of console.warn
...
- [ ] [Backend] [High] MusicXMLParser: warn on skipped notes instead of silent return
...
- [ ] [Backend] [High] ScoreRenderer.renderDebugLabel(): replace silent null check with assertion
...
- [ ] [Both] [High] ScoreDetailClient: show error UI instead of console.error on failed data parse
...
- [ ] [UI] [High] ScoreEditor: notify user when autosave restore fails
...
- [ ] [Backend] [High] AuthStateManager: document or fix the async initialization race condition
...
- [ ] [Backend] [High] forkScore: check error on fork count increment
...
- [ ] [Backend] [High] forkScore: handle slug query error in createScore
...
- [ ] [Backend] [High] ScoreDetailClient.handleFork: preserve error context in catch block
...
- [ ] [Backend] [High] AuthComponents.show(): remove pointless double toggleMode() call
...
- [ ] [UI] [High] Extract ScoreEditor inline CSS into a stylesheet
...
- [ ] [UI] [High] Extract ScoreLibrary inline CSS into a stylesheet
...
- [ ] [Backend] [High] Extract score data validation out of ScoreEditor into a reusable module
...
- [ ] [Backend] [High] Extract auto-save logic out of ScoreEditor
...
- [ ] [Backend] [High] Extract createScore slug generation into its own function
...
- [ ] [Backend] [High] Extract auth subscription boilerplate into a shared page initializer
...
- [ ] [Both] [High] Separate auth check from DOM mutation in ScoreDetailClient.handleEditButtonVisibility
...
- [ ] [Backend] [High] Move MusicXML parsing out of ScoreDetailClient
...
- [ ] [UI] [Medium] Standardize error UX across components
...
- [ ] [Backend] [Medium] Slug utility: handle Unicode characters (Japanese score titles)
...
- [ ] [Backend] [High] Replace hardcoded fallback viewport 800×600 with explicit error or documented default
...
- [ ] [Backend] [High] Document or name the MusicXMLParser duration mapping thresholds
...
- [ ] [Backend] [High] Name magic numbers in VerticalSystem separator drawing
...
- [ ] [Backend] [High] Name the auto-save interval constant in ScoreEditor
...
- [ ] [Backend] [High] Document MIDI tick values in Formatter.ts
...
- [ ] [Backend] [High] Name magic number for rest vertical centering in ShakuNote
...
- [ ] [Backend] [High] Name magic number for duration line baseline ratio
...
- [ ] [Backend] [High] Extract hardcoded editor URL into a route constant
...
- [ ] [Backend] [Medium] Replace meri/chu_meri/dai_meri boolean flags with a discriminated union
...
- [ ] [Backend] [Medium] Type the `data` field in Score/CreateScoreData/UpdateScoreData instead of `any`
...
- [ ] [Backend] [High] Fix handleMetadataChange double `as any` cast in ScoreEditor
...
- [ ] [Backend] [High] Remove `undefined as any` hack from DEFAULT_RENDER_OPTIONS
...
- [ ] [Both] [High] Replace MutationObserver theme detection with a custom event
...
- [ ] [Backend] [Medium] Decouple ColumnLayoutCalculator from DurationDotModifier
...
- [ ] [Backend] [High] Move MusicXMLParser out of ScoreRenderer
...
- [ ] [Backend] [High] Remove TestModifier from public API exports
...
- [ ] [Backend] [Medium] Evaluate whether Formatter and VerticalSystem should be public API
...
- [ ] [Backend] [High] Move toJSON/convertToJSON off MusicXMLParser
...
- [ ] [UI] [High] Refactor AuthModal to use ConfirmDialog (DRY violation)
...
- [ ] [UI] [High] Deduplicate empty-state grid template in ScoreLibrary
...
- [ ] [UI] [High] Deduplicate score card click listener attachment in ScoreLibrary
...
- [ ] [Backend] [High] Rename ScoreDetailClient's local ScoreData interface to avoid shadowing
...
- [ ] [Backend] [High] Extract repeated error wrapping pattern in scores.ts
...
- [ ] [Backend] [High] Move curated score slugs to a configuration file
...
- [ ] [Backend] [High] Add unit tests for MusicXMLParser
...
- [ ] [Both] [High] Add unit tests for ScoreEditor validation and save logic
...
- [ ] [Backend] [High] Add unit tests for SVGRenderer group management
...
- [ ] [Backend] [High] Add unit tests for modifier rendering logic
...
- [ ] [UI] [High] Replace waitForTimeout with waitForSelector in visual regression tests
...
- [ ] [Backend] [High] Verify mock was called in convenience.test.ts
...
- [ ] [Backend] [High] Add unit tests for auth module
...
- [ ] [Backend] [High] Add unit tests for scores.ts CRUD operations
...
- [ ] [Both] [High] Add unit tests for ScoreLibrary component logic
...
- [ ] [Backend] [Medium] Extract a RenderingBackend interface from SVGRenderer
...
- [ ] [Backend] [Medium] Introduce a Parser interface and registry
...
- [ ] [Both] [Low] Decompose ScoreEditor into model + view
...
- [ ] [Both] [High] Fix potential theme detection bug: MutationObserver watches wrong attribute
...
- [ ] [UI] [Medium] Enable musicians to read through long scores without scrolling (when score exceeds viewport height, allow "page turn" navigation with keyboard/UI controls so players can advance through the score while performing)
- [ ] [UI] [Medium] Add score selector dropdown
- [ ] [Backend] [Medium] Load different score files dynamically
- [ ] [Backend] [High] Add JSDoc comments to public APIs
- [ ] [Backend] [Medium] Write usage guide in reference/README.md
- [ ] [Backend] [Medium] Document score data format

### Additional Modifiers

- [ ] [Backend] [Medium] YuriModifier (vibrato)
- [ ] [Backend] [Medium] MuraikiModifier (breathy tone)
- [ ] [Backend] [Medium] SuriModifier (sliding)
- [ ] [Backend] [Medium] OriModifier (pitch bend)
- [ ] [Backend] [Medium] Centered duration line style (line passes horizontally through middle of note, alternative to current right-aligned style)

### Performance & Optimization

- [ ] [Backend] [Medium] Profile rendering performance
- [ ] [Backend] [Medium] Optimize frequent operations
- [ ] [Backend] [Medium] Add caching where appropriate
- [ ] [Backend] [Low] Revisit column breaking with TeX-inspired badness algorithm
...
- [ ] [UI] [Low] Visual score editor (point-and-click note entry)
- [ ] [Both] [Low] OCR tool (scan physical scores to MusicXML/JSON)
- [ ] [Both] [Medium] Collections (curated score groups)
- [ ] [Both] [Medium] Version history (track edits over time)
- [ ] [Both] [Medium] Comments/discussions on scores
- [ ] [Both] [Low] Pull request workflow (suggest changes to others' scores)
- [ ] [Backend] [Medium] Private scores (unlisted or private visibility)
- [ ] [Both] [Medium] Export/download scores as files
- [ ] [UI] [Medium] Print optimization (CSS for clean printouts)
- [ ] [Both] [Medium] Advanced search (filter by tags, difficulty, date ranges)
- [ ] [Backend] [Medium] Multiple score input formats (import from ABC, etc.)
- [ ] [Backend] [Low] MIDI playback mapping
- [ ] [Backend] [Medium] Western staff intermixing
- [ ] [Backend] [Medium] Custom font support for traditional glyphs
- [ ] [Backend] [Medium] Score transposition tool
